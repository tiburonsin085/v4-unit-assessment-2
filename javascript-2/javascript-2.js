...
//   products[i].price *= 0.75
// }
var saleProducts = products.map((n,i) => {
...
var blueProducts = saleProducts.filter((elem, i) => (products[i].color).includes('blue') === true)
...
const person ={
  name:'esteban',
  age: 25,
  jobs: ['engineer', 'web developer', 'the bboss'],
  birthday: function(){
    return this.age += 1
  },
  favorites: {
